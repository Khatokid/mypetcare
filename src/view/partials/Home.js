...
const homePage = () => {
  // Add the functionality you need here
  ...
  return (
    ...
    {Array.from({ length: totalSlides }).map((_, index) => (
      ...
      <section className="contact" id="contact">
        <div className="question"  data-aos="flip-left">
        <img
...
<div className="quick-question">
      ...
      <div className="footer-container">
        ...
        <div className="footer-info"><p>52 Huỳnh Đình Hai, P.14, Q. Bình Thạnh, TP.HCM</p>
          <p>Hotline: 0762 029 029</p>
          <p>Email: xxxxx@hotmail.com</p>
          </div>
         
          <div className="footer-title"> Không ngừng nâng cao chất lượng phục vụ, 
nâng tầm chuyên môn để mang đến quý khách hàng
 những dịch vụ hoàn hảo nhất...</div>
